...
const ITEMS = [
  {
    id: "github", label: "GITHUB", handle: "@abijit2626", href: "https://github.com/abijit2626", icon: "🐙", barIcon: icon1,
    details: [
      { label: "USER", value: "abijit2626", icon: "👤" },
      { label: "ROLE", value: "SOC / Blue Team", icon: "🛡️" },
      { label: "LOC", value: "Palakkad, India", icon: "📍" }
    ],
    stats: [],
  },
  {
    id: "linkedin", label: "LINKEDIN", handle: "Abijit Arun", href: "https://linkedin.com", icon: "💼", barIcon: icon2,
    details: [
      { label: "USER", value: "Abijit Arun", icon: "👤" },
      { label: "ROLE", value: "CS Student", icon: "🎓" },
