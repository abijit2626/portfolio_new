...
const REVEAL_CONTENT = [
  {
    upper: [`${profile.name}`, `Focus: Defensive Security / Blue Team`],
    lower: `Location: Palakkad, India`,
  },
  {
    upper: [
      `Languages: Python, C, Bash`,
      `Security: Wazuh SIEM, Wireshark, Nmap, Burp Suite`,
      `Practice: CTFs, Bug Bounty, Lab Environments`,
    ],
    lower: "Understanding attacker behavior well enough to catch it",
  },
  {
    upper: [
    ...
    lower: "Current focus areas in cybersecurity journey",
  },
];
...
const ITEMS = [
  {
    ...
    stats: [
      ...
      { tag: "Focus", value: "Blue Team", color: "#e8c100" },
    ],
  },
  {
